...
(function () {
  ...
  var CSS = [
    ...
    '.ea-launcher{display:inline-flex;align-items:center;gap:0;border:0;padding:8px;border-radius:999px;background:#fff;box-shadow:0 12px 30px rgba(39,56,105,.18);cursor:pointer;transition:transform .15s ease,box-shadow .15s ease}',
    ...
    '.ea-launcher-label{display:inline-block;font-size:14px;font-weight:700;color:#12151f;white-space:nowrap;overflow:hidden;max-width:0;opacity:0;margin-left:0;padding-right:0;animation:eaPeek 10s ease-in-out infinite}',
    '.ea-launcher:hover .ea-launcher-label{animation:none;max-width:190px;opacity:1;margin-left:8px;padding-right:10px}',
    '@keyframes eaPeek{0%,4%{max-width:0;opacity:0;margin-left:0;padding-right:0}10%{opacity:1}14%,30%{max-width:190px;opacity:1;margin-left:8px;padding-right:10px}40%,100%{max-width:0;opacity:0;margin-left:0;padding-right:0}}',
